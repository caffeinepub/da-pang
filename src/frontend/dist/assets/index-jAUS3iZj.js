...
const Repeat2 = createLucideIcon("repeat-2", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function useTokenStats() {
  ...
  const fetch_ = reactExports.useCallback(async () => {
    var _a2, _b2, _c2;
    try {
      ...
      setStats({
        ...
        volume24h: formatNumber(((_b2 = pair.volume) == null ? void 0 : _b2.h24) || 0),
        liquidity: formatNumber(((_c2 = pair.liquidity) == null ? void 0 : _c2.usd) || 0)
      });
      setError(false);
    } catch {
      setError(true);
  ...
  reactExports.useEffect(() => {
    fetch_();
    const interval = setInterval(fetch_, 3e4);
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "DA PANG" }),
            " 🐕"
          ]
        }
      ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiTelegram, { size: 20 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "text-muted-foreground hover:text-foreground transition-colors",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 18 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "btn-golden rounded-full px-5 h-9 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: JUPITER_URL,
            target: "_blank",
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-background border-b border-border px-4 pb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "btn-golden w-full mt-3 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: JUPITER_URL, target: "_blank", rel: "noopener noreferrer", children: "Buy $PANG" }) })
    ] })
  ] });
}
function MobileBottomNav() {
  const items = [
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(House, { size: 20 }), label: "Home", href: "#home" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 20 }), label: "Chart", href: "#chart" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { size: 20 }), label: "Buy", href: "#buy" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 20 }), label: "Community", href: "#community" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleHelp, { size: 20 }), label: "FAQ", href: "#faq" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "md:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-t border-border mobile-nav-safe", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-around py-2", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      href: item.href,
...
function Marquee({ flip = false }) {
  const text = "🐕 DA PANG 🚀 CpP36fvZmbcDUH9tQihQZTcvH2ApwRzHh2pPojyWpump 🔥 26M VIEWS 💎 THE LEGEND LIVES 🌟 DA PANG 🐕";
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text font-display font-700 text-sm tracking-wide whitespace-nowrap px-8", children: repeated }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text font-display font-700 text-sm tracking-wide whitespace-nowrap px-8", children: repeated })
          ]
        }
      )
...
function CopyButton({ text }) {
  ...
  const copy = () => {
    ...
    setCopied(true);
    ue.success("CA copied to clipboard!");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "max-w-[160px] sm:max-w-[280px] truncate", children: text }),
        copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 14, className: "text-chart-2 shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          Copy,
          {
            size: 14,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(circle, oklch(0.75 0.15 55 / 0.06) 0%, transparent 70%)"
            }
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-up mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-up fade-up-delay-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-card border border-border rounded-full px-4 py-1.5 text-xs font-medium text-muted-foreground mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-green w-2 h-2 rounded-full bg-current inline-block animate-pulse" }),
            "Live on Solana"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "fade-up fade-up-delay-1 font-display font-extrabold text-5xl md:text-7xl lg:text-8xl mb-4 leading-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Dà Pàng" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fade-up fade-up-delay-2 text-xl md:text-2xl text-muted-foreground font-medium mb-2", children: "The Legendary Chubby Corgi 🐕‍🦺" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "fade-up fade-up-delay-2 text-base text-muted-foreground mb-6 max-w-xl", children: [
            "26M+ viral views. The heroic dog who led a stolen pack 17km back to freedom. ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden sm:block" }),
            "Now immortalized on Solana."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-up fade-up-delay-3 mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { text: CA }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-up fade-up-delay-4 flex flex-col sm:flex-row items-center gap-3 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                asChild: true,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#chart", "data-ocid": "hero.chart.button", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 16, className: "mr-2" }),
                  " View Chart"
                ] })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-up fade-up-delay-4 flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: TG_URL,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SiTelegram, { size: 18 }),
                  " Telegram"
                ]
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                className: "flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 16 }),
                  " Community"
                ]
              }
            )
...
function TokenomicsSection() {
  ...
  const cards = [
    {
      label: "Price",
      value: stats == null ? void 0 : stats.price,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { size: 20 }),
      suffix: ""
    },
    {
      label: "Market Cap",
      value: stats == null ? void 0 : stats.marketCap,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 20 }),
      suffix: ""
    },
    {
      label: "24h Volume",
      value: stats == null ? void 0 : stats.volume24h,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 20 }),
      suffix: ""
    },
    {
      label: "Liquidity",
      value: stats == null ? void 0 : stats.liquidity,
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 20 }),
      suffix: ""
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "tokenomics", className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl md:text-4xl mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Tokenomics" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Live data from DexScreener — refreshes every 30 seconds" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: cards.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-3 text-primary", children: card.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-1", children: card.label }),
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-extrabold text-2xl text-foreground", children: card.value ?? "—" })
            ]
          },
          card.label
        ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid md:grid-cols-3 gap-4 text-center", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-extrabold text-3xl gradient-text mb-1", children: item.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-sm", children: item.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs mt-1", children: item.desc })
        ]
      },
      item.label
    )) })
...
function LoreSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "lore", className: "py-20 px-4 bg-card border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-5xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 badge-green border rounded-full px-3 py-1 text-xs font-semibold mb-4", children: "🔥 26M+ Tweet Views" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl md:text-4xl mb-6 leading-tight", children: [
        "The Legend of ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Dà Pàng" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-muted-foreground leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: '"Big Fat"' }),
          " in Chinese — proved that true heroes come in the chubbiest packages."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "When dog thieves struck and stole an entire pack of dogs, Dà Pàng didn't sit still. This brave, round-bellied corgi somehow broke free from the captors and did the unthinkable:" }),
        ...
        ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "flex items-start gap-2 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item }) }, item)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The internet exploded. 26 million views. Millions of shares. A chubby corgi became a global hero — and the most bullish narrative for a memecoin the crypto world has ever seen." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "btn-golden rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: JUPITER_URL,
            target: "_blank",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "radial-gradient(circle, oklch(0.75 0.15 55 / 0.2) 0%, transparent 70%)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function ChartSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "chart", className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl md:text-4xl mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Live Chart" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Real-time $PANG price action on DexScreener" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function BuySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "buy", className: "py-20 px-4 bg-card border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl md:text-4xl mb-3", children: [
        "How to Buy ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "$PANG" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Get your $PANG in 4 simple steps" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 md:grid-cols-4 gap-4 mb-12", children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-primary uppercase tracking-widest mb-1", children: [
            "Step ",
            i + 1
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base mb-2", children: step.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3", children: step.desc }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        "data-ocid": "buy.panel",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background px-5 py-4 border-b border-border flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold", children: "🪐 Jupiter Swap" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: JUPITER_URL,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 p-4 bg-background rounded-xl border border-border flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mb-1", children: "Contract Address (CA)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs text-foreground break-all", children: CA })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { text: CA })
    ] })
  ] }) });
}
function CommunitySection() {
  const tweets = [
    {
      ...
      name: "Crypto Herald",
      handle: "@cryptoherald",
      content: "This chubby corgi just escaped dog thieves AND led the entire pack 17km back home! HERO DOG 🐕 The story that launched a thousand memecoins. #DaPang #Solana",
      views: "26.4M",
      likes: "892K",
      retweets: "340K",
      time: "2h ago"
    },
    {
      ...
      name: "DeFi Degen",
      handle: "@defidegen",
      content: "The story of Dà Pàng is the most wholesome and badass thing I've read all week. Big Fat Corgi = Big Fat Gains 🚀 Already in. CT please don't sleep on this.",
      views: "4.1M",
      likes: "1.2M",
      retweets: "215K",
      time: "5h ago"
    },
    {
      ...
      name: "Solana News",
      handle: "@solanews",
      content: "17 KILOMETERS. This corgi walked 17km to bring stolen dogs home. If this isn't the most bullish narrative you've seen all year, idk what is 🔥 #DaPang $PANG",
      views: "8.9M",
      likes: "620K",
      retweets: "890K",
      time: "8h ago"
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "community", className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 badge-green border rounded-full px-3 py-1 text-xs font-semibold mb-4", children: "🔥 The Viral Story" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl md:text-4xl mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "26M Views" }),
        " — The World Watched"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "The internet went wild for Dà Pàng. Here's what they said." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4 mb-12", children: tweets.map((tweet, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-xl", children: tweet.avatar }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm text-foreground", children: tweet.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: tweet.handle })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 14, className: "text-muted-foreground" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed mb-4", children: tweet.content }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs text-muted-foreground border-t border-border pt-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto", children: tweet.time })
          ] })
        ]
      },
      tweet.handle
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl mb-2", children: "Join the Pack 🐕" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "Thousands of degens already running with Dà Pàng. Don't get left behind." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row justify-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "btn-golden rounded-full h-11 px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: TG_URL,
            target: "_blank",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SiTelegram, { className: "mr-2", size: 16 }),
              " Join Telegram"
            ]
          }
        ) }),
          ...
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { className: "mr-2", size: 14 }),
                  " Join X Community"
                ]
              }
            )
...
function FaqSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "py-20 px-4 bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl md:text-4xl mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "FAQ" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Everything you need to know about $PANG" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Accordion,
      {
        ...
        children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          AccordionItem,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-semibold text-left hover:no-underline py-5 text-sm md:text-base", children: faq.q }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-muted-foreground text-sm leading-relaxed pb-5", children: faq.a })
            ]
          },
          faq.q
        ))
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-background border-t border-border py-10 px-4 pb-20 md:pb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display font-bold text-xl mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "DA PANG" }),
          " 🐕"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-mono", children: CA })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            className: "flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SiTelegram, { size: 16 }),
              " Telegram"
            ]
          }
        ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 pt-6 border-t border-border flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-center", children: "$PANG is a memecoin with no intrinsic value. Not financial advice. DYOR." })
    ] })
  ] }) });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "pb-16 md:pb-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Marquee, { flip: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BuySection, {}),
